<template>
  ...
  <section class="section">
    ...
    <div class="container">
    <div class="button is-pulled-right" @click="open=true"  type="button"><img class='t' :src='cart' width='25px' height='25px'/><span v-if="kosarica_popunjena==true" class="item is-pulled-right">
...
<div class="card "  style="height:100%; padding-top:10px;"><!-- 100% mora biti da mi svi card elementi- blokići u kojima je proizvod budu iste visine!!!-->
...
<!--    <div class="row team-images">-->
     <div class="container is-centered is-paddingless is-marginless"><!--ta mi je važna za centriranje-->
         ...
         <router-link v-bind:to="'item/' + item.id">
              <figure class="container" width="80%" height="70%">
                 <img  :src='item.picture' class="picture"  width="80%" height="70%" alt="" />
              </figure>
         </router-link>
        ...
        <div class="columns is-centered">
            <div class="container">
              <!--<p class="html">{{item.opis |to-skraceno}}</p>-->
                <div class="content is-centered  is-size-7-mobile is-size-6-tablet is-size-6-touch">{{item.desc |to-skraceno}}</div>
            </div>
        </div>
      </div>
      <div class="content">
...
import prva from '../assets/prva.jpg'
import druga from '../assets/druga.jpg'
import treca from '../assets/treca.jpg'
import peta from '../assets/peta.jpg'
import sesta from '../assets/sesta.jpg'
...
methods:{
  hideModal() {
    ...
    this.kosarica2=[];
        ...
        /*
        post:function(){
      //    this.$http.post('https://shop-158bc.firebaseio.com/food.json', {id:15,code:390, name:"Food", picture:sesta,price:'20,00',desc:"Slovenec Slovenec SlovenecSlovenec Slovenec Slovenec Slovenec Slovenec."}).then(function(data){
        //    this.$http.post('https://shop-158bc.firebaseio.com/food.json', {id:12,code:390, name:"Neke", picture:druga,price:'15.50,00',desc:"Draš Slovenecnekakve bedastoće nadrobim..."}).then(function(data){
            //  this.$http.post('https://shop-158bc.firebaseio.com/food.json', {id:13,code:390, name:"Ručak", picture:prva,price:'22,00',desc:"Ručak: juha od graška 150g kuhane govedine pire krumpir umak od rajčice"}).then(function(data){
        //  this.$http.post('https://shop-158bc.firebaseio.com/food.json', {id:14,code:390, name:"Corny big", picture:peta,price:'20,00',desc:"Corny big čokoladica black and white. Milkkkkk. :) Kravica..."}).then(function(data){
...
created(){
  ...
  this.$http.get('https://shop-158bc.firebaseio.com/food.json').then(function(data){
  //  console.log(data);
    return data.json();
  }).then(function(data){
    var itemArray=[];
